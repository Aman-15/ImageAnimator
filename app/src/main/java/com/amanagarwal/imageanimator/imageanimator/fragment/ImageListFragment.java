...
public class ImageListFragment extends Fragment implements ImageDataListener, ImageOnClickListener {
    ...
    public static ImageListFragment newInstance() {return new ImageListFragment();}
    ...
    public void onStart() {
        ...
        adaptor = new ImageAdapter(null, this);
    ...
    @Override
    public void zoomImageFromThumb(final View thumbView, Drawable image, String url) {
